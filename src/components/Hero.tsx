  ...
  return (
    ...
    >
      ...
      <div className="container mx-auto relative z-10 pt-24 flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
        ...
        <div 
          ref={profileRef}
          className="w-full lg:w-1/3 flex justify-center opacity-0 translate-y-8 transition-all duration-700"
        >
        ...
        <div 
          ...
          className="w-full lg:w-1/2 text-center lg:text-left opacity-0 transition-opacity duration-1000 delay-300"
        >
          ...
          <div className="opacity-0 animate-fade-in animate-delay-800 flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mt-8">
            <a 
              href="#contact" 
              className="px-6 py-3 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition-all"
            >
              Get in Touch
            </a>
      ...
      <button 
        ...
        className="absolute bottom-12 left-1/2 transform -translate-x-1/2 flex flex-col items-center opacity-0 animate-fade-in animate-delay-800"
